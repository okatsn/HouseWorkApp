...
@testset "DocTests" begin
    DocMeta.setdocmeta!(Worker, :DocTestSetup, :(using Worker); recursive=true)
    # using the package everywhere in the doc
    # See also https://documenter.juliadocs.org/stable/man/doctests/#Setup-Code


    doctest(Worker; manual = false) # this makes jldoctest also be tested in a local test
end
